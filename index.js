...
const uri =
  'mongodb+srv://rahimbadsa723:Ofqat5fdGeCj9PDc@cluster0.r2ad8dg.mongodb.net/?retryWrites=true&w=majority';
...
async function run() {
  try {
    ...
    const brandCollection = client
      .db('brandNameDB')
      .collection('brandNameDBCollection');
    const productCollection = client
      .db('productDB')
      .collection('productDBCollection');
    ...
    app.post('/addproduct', async (req, res) => {
      try {
        ...
        // Create a new ObjectId for the document
        const objectId = new ObjectId();

        // Add the ObjectId to the ProductData
        ProductData._id = objectId;
